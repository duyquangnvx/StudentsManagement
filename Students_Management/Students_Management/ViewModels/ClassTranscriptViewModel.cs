...
{
    public class ClassTranscriptViewModel : BaseViewModel
    {
        ...
        public ClassTranscriptViewModel(LopHoc c) : this()
        {
            SelectedClass = c;
            Filter(SelectedClass.HocSinhs.ToList());
        }

        private void Filter(List<HocSinh> finalScores)
        {
            FilterList = new List<HocSinh>(finalScores);
        }
